    ...
    <div class="login-container">
      <div class="login-box">
        <app-card [elevated]="true">
          ...
          <p class="subtitle">Acesse sua conta de profissional de saúde</p>
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
            <div class="form-group">
              ...
              <input
                ...
                placeholder="seu.email@professional.com"
                [attr.aria-label]="'Email do profissional'"
              />
            ...
            <div class="form-group">
              ...
              <input
                ...
                [attr.aria-label]="'Senha do profissional'"
              />
...
export class ProfessionalLoginComponent implements OnInit {
  loginForm!: FormGroup;
  isLoading$ = new BehaviorSubject<boolean>(false); // Será substituído por Observable
  ...
  onSubmit(): void {
    if (this.loginForm.valid) {
      ...
      this.authService.loginProfessional(credentials)
        .pipe(
          finalize(() => {
  ...
  navigateToSignup(): void {
    this.router.navigate(['/signup/professional']);
  }
}
